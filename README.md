...
default street map style view to a dark map view using the control box in the upper right corner.

![](2020-08-19-15-57-35.png)

The second map show a global image of earthquakes in the past 7 days and techtonic plate boundaries.  Circle
